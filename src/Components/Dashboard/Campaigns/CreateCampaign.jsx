		 ...
		 <div className="px-2 w-full h-full">
			 ...
			 >
				 ...
				 <form onSubmit={handleSubmit}>
					 ...
					 <div
					  className={'sm:w-[350px] w-full flex justify-center items-center border-b-2  border-gray-500'}>
						 <Select required variant="static" label="دسته بندی" onChange={(e) => setCategory(e)}>
							 {commonData.categories ? commonData.categories.map(category => <Option
